...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    sideOffset={6}
    className={cn(
      "z-50 min-w-48 overflow-hidden rounded-xl border border-slate-200 bg-white p-1 shadow-xl",
...
const DropdownMenuShortcut = ({
  ...
  <span
    className={cn("ml-auto text-xs tracking-wide text-slate-400", className)}
    {...props}
  />
);
